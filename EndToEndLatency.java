       ...
       // ArgumentParser parser = argParser();
        ...
        //    Map<String, Object> producerProps = getProperties(res.getList("producerConfig"));
           ...
           // props.put(ConsumerConfig.AUTO_OFFSET_RESET_CONFIG, "earliest");
            props.put(ConsumerConfig.GROUP_ID_CONFIG, "reactivekafka-perf-21");
           ...
           // if (useReactive) {
           //  test = new ReactiveEndToEndLatency(props, producerProps, "localhost:9092", "neurontest4");
           // } else {
              test = new NonReactiveEndToEndLatency(props, producerProps, "localhost:9092", "neurontest4");
           // }

            test.runTest(15000, 100, timeout);
  ...
  /*  private static ArgumentParser argParser() {
    ...
    static abstract class AbstractEndToEndLatency {
        ...
        public double[] runTest(int numMessages, int messageSize, Long timeout) throws Exception {
            ...
            System.out.printf("Total latency: %.4f ms\n\n", totalTime / 1000.0 / 1000.0);
